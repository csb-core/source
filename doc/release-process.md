...
###Build CSbank Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the CSbank.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the CSbank.org release
...
- Announce the release:
  ...
  - CSbank-development mailing list

  - Update title of #bitcoin on Freenode IRC

  - Optionally reddit /r/CSbank, ... but this will usually sort out itself
